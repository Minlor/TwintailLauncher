        ...
        return (
            <div className="w-full" style={this.props.style || {}}>
                <input id={this.props?.id}
                    ...
                    className={`text-ellipsis w-full focus:outline-none h-10 rounded-xl bg-zinc-800/60 border border-white/10 text-white px-3 placeholder-white/50 focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/30 transition-colors ${this.props.isPicker ? "cursor-pointer" : ""}`}
