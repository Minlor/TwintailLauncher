...
pub fn list_installed_runners(app: LauncherContext) -> Option<String> {
    #[cfg(target_os = "linux")]
    {
...
pub fn get_installed_runner_by_id(app: LauncherContext, runner_id: String) -> Option<String> {
...
pub fn get_installed_runner_by_version(app: LauncherContext, runner_version: String) -> Option<String> {
...
#[allow(unused_variables)]
pub fn update_installed_runner_install_status(app: LauncherContext, version: String, is_installed: bool) -> Option<bool> {
    #[cfg(target_os = "linux")]
    {
...
#[allow(unused_variables)]
pub fn add_installed_runner(app: LauncherContext, runner_url: String, runner_version: String) -> Option<bool> {
...
pub fn remove_installed_runner(app: LauncherContext, runner_version: String) -> Option<bool> {
...
#[allow(unused_variables)]
pub fn is_steamrt_installed(app: LauncherContext) -> bool {
    #[cfg(target_os = "linux")]
    {
