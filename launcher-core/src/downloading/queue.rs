...
use serde::Serialize;
use crate::runtime::{LauncherContext, Emitter};
...
fn emit_queue_state(app: &LauncherContext, max_concurrent: usize, paused: bool, auto_paused: bool, active: &HashMap<String, QueueJobView>, queued: &VecDeque<QueueJobView>, completed: &VecDeque<QueueJobView>, paused_jobs: &HashMap<String, QueueJobView>, pausing_installs: &HashSet<String>) {
...
pub fn start_download_queue_worker(app: LauncherContext, initial_max_concurrent: usize, run_job: fn(LauncherContext, QueueJob) -> QueueJobOutcome) -> DownloadQueueHandle {
