...
pub fn register_download_handler(app: &LauncherContext) {
    let a = app.clone();
...
pub fn run_game_download(h4: LauncherContext, payload: DownloadGamePayload, job_id: String) -> QueueJobOutcome {
