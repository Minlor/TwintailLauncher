...
pub fn register_preload_handler(app: &LauncherContext) {
    let a = app.clone();
...
pub fn run_game_preload(h5: LauncherContext, payload: DownloadGamePayload, job_id: String) -> QueueJobOutcome {
