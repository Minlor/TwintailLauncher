...
use crate::utils::{resolve_app_data_dir, run_async_command, setup_or_fix_default_paths};
...
pub async fn init_db(app: &LauncherContext) {
...
pub fn get_settings(app: &LauncherContext) -> Option<GlobalSettings> {
    let mut rslt = vec![];
...
pub fn update_settings_third_party_repo_update(app: &LauncherContext, enabled: bool) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_settings_default_game_location(app: &LauncherContext, path: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_settings_default_xxmi_location(app: &LauncherContext, path: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_settings_default_fps_unlock_location(app: &LauncherContext, path: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_settings_default_jadeite_location(app: &LauncherContext, path: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_settings_default_prefix_location(app: &LauncherContext, path: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_settings_default_runner_location(app: &LauncherContext, path: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_settings_download_speed_limit(app: &LauncherContext, limit_kb_per_sec: i64) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_settings_default_dxvk_location(app: &LauncherContext, path: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_settings_default_mangohud_config_location(app: &LauncherContext, path: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_settings_launch_action(app: &LauncherContext, action: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_settings_hide_manifests(app: &LauncherContext, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn create_repository(app: &LauncherContext, id: String, github_id: &str) -> Result<bool, Error> {
...
pub fn delete_repository_by_id(app: &LauncherContext, id: String) -> Result<bool, Error> {
    let mut rslt = SqliteQueryResult::default();
...
pub fn get_repository_info_by_id(app: &LauncherContext, id: String) -> Option<LauncherRepository> {
    let mut rslt = vec![];
...
pub fn get_repositories(app: &LauncherContext) -> Option<Vec<LauncherRepository>> {
    let mut rslt = vec![];
...
pub fn delete_manifest_by_id(app: &LauncherContext, id: String) -> Result<bool, Error> {
    let mut rslt = SqliteQueryResult::default();
...
pub fn get_manifest_info_by_id(app: &LauncherContext, id: String) -> Option<LauncherManifest> {
    let mut rslt = vec![];
...
pub fn update_manifest_enabled_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn delete_installation_by_id(app: &LauncherContext, id: String) -> Result<bool, Error> {
    let mut rslt = SqliteQueryResult::default();
...
pub fn get_install_info_by_id(app: &LauncherContext, id: String) -> Option<LauncherInstall> {
    let mut rslt = vec![];
...
pub fn get_installs(app: &LauncherContext) -> Option<Vec<LauncherInstall>> {
    let mut rslt = vec![];
...
pub fn update_installs_order(app: &LauncherContext, order_updates: Vec<(String, i32)>) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_game_location_by_id(app: &LauncherContext, id: String, location: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_game_background_by_id(app: &LauncherContext, id: String, background: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_runner_location_by_id(app: &LauncherContext, id: String, location: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_dxvk_location_by_id(app: &LauncherContext, id: String, location: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_ignore_updates_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_skip_hash_check_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_use_jadeite_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_use_xxmi_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_use_fps_unlock_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_fps_value_by_id(app: &LauncherContext, id: String, fps: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_graphics_api_by_id(app: &LauncherContext, id: String, api: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_install_use_gamemode_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_use_mangohud_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_env_vars_by_id(app: &LauncherContext, id: String, env_vars: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_pre_launch_cmd_by_id(app: &LauncherContext, id: String, cmd: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_launch_cmd_by_id(app: &LauncherContext, id: String, cmd: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_prefix_location_by_id(app: &LauncherContext, id: String, location: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_launch_args_by_id(app: &LauncherContext, id: String, args: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
#[allow(dead_code)]
pub fn update_install_runner_version_by_id(app: &LauncherContext, id: String, version: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
#[allow(dead_code)]
pub fn update_install_dxvk_version_by_id(app: &LauncherContext, id: String, version: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_shortcut_location_by_id(app: &LauncherContext, id: String, location: String) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
#[allow(dead_code)]
pub fn update_install_shortcut_is_steam_by_id(app: &LauncherContext, id: String, is_steam: bool) {
    run_async_command(async {
        let db = app
            .state::<DbInstances>()
            .0
...
pub fn update_install_last_played_by_id(app: &LauncherContext, id: String, last_played_time: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_install_total_playtime_by_id(app: &LauncherContext, id: String, total_playtime: String) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_install_show_drpc_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn update_install_disable_system_idle_by_id(app: &LauncherContext, id: String, enabled: bool) {
    run_async_command(async {
        let db = app.state::<DbInstances>().0.lock().await.get("db").unwrap().clone();
...
pub fn get_installed_runners(app: &LauncherContext) -> Option<Vec<LauncherRunner>> {
    let mut rslt = vec![];
...
pub fn get_installed_runner_info_by_id(app: &LauncherContext, id: String) -> Option<LauncherRunner> {
    let mut rslt = vec![];
